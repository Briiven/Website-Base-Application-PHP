					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								$sql = "SELECT application.id as lid, RAstaffID, durationID, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, applicants.program, application.appType, application.appDate, application.RAstatus, application.CRstatus, application.DHstatus, application.CDstatus, application.RAremarkDate 
                        	FROM application 
							...
							ORDER BY lid DESC LIMIT 10";
								...
								?>
									...
									<td><?php echo $row['RAremarkDate']; ?></td>
									<td>
