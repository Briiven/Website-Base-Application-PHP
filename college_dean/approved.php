				...
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							...
							$CDstatus = 1;
							$sql = "SELECT application.id as lid, durationID, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, applicants.program, application.appType, application.appDate, application.CDstatus, application.CDremarkDate
									FROM application
							...
							?>
								<tr>
									...
									<td><?php echo $row['CDremarkDate']; ?></td>
									<td>
