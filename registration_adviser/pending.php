                    ...
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                $sql = "SELECT application.id as lid, durationID, RAstaffID, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, application.appType, application.appDate, application.RAstatus, application.CRstatus, application.DHstatus, application.CDstatus 
                                FROM application 
