					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								$sql = "SELECT application.id as lid, durationID, RAstaffID, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, applicants.program, application.appType, application.appDate, application.RAstatus, application.CRstatus, application.DHstatus, application.CDstatus FROM application JOIN applicants ON application.appID = applicants.appID 
								WHERE durationID = $session_duration_id  AND RAstaffID = '$session_id' ORDER BY lid DESC LIMIT 10";
