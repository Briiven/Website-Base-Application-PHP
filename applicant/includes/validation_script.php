    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handlePreviousButtonClick1() {
            if (currentSectionIndex >= 7) {
                currentSectionIndex -= 7; // Move back six sections
                showSection(currentSectionIndex);
            } else {
        ...
        document.getElementById('regad_next').addEventListener('click', handleNextButtonClick);
        document.getElementById('personal_info_prev').addEventListener('click', handlePreviousButtonClick);
        ...
        document.getElementById('regad_next').disabled = true;
        ...
        // Validation for Registration Adviser Selection
        var RAstaffID = document.querySelector('select[name="RAstaffID"]');

        RAstaffID.addEventListener('change', function() {
            validateSelecta(this, 'Registration Adviser is required');
        });

        function validateSelecta(input, errorMessage) {
            ...
            if (value === '') {
                ...
                showSuccess(input);
                checkRequiredFields6();
                return true;
            }
        }

        function checkRequiredFields6() {
            // Check if all required fields are valid
            if (RAstaffID.value.trim() !== '') {
        ...
        shsInput.addEventListener('input', function() {
            validateOptionalInput(this, /^[a-zA-Z0-9,\sñÑ\-'.]+$/, 'Senior Highschool is required');
        });

        shsAddressInput.addEventListener('input', function() {
            validateOptionalInput(this, /^[a-zA-Z0-9,\sñÑ\-'.]+$/, 'Senior Highschool Address is required');
        });
        ...
        oscInput.addEventListener('input', function() {
            validateOptionalInput(this, /^[a-zA-Z0-9,\sñÑ\-'.]+$/, 'Invalid Input');
        });
        ...
        function checkAllRequiredFields() {
            ...
            if (shsInput.value.trim() !== '' || shsAddressInput.value.trim() !== '' ||
                /^[a-zA-Z0-9,\sñÑ\-'.]+$/.test(shsInput.value.trim()) ||
                /^[a-zA-Z0-9,\sñÑ\-'.]+$/.test(shsAddressInput.value.trim()) ||
        ...
        var sevenfirstInput = document.querySelector('input[name="sevenfirst"]');
        var sevensecondInput = document.querySelector('input[name="sevensecond"]');
        var sevensummerInput = document.querySelector('input[name="sevensummer"]');
        var eightfirstInput = document.querySelector('input[name="eightfirst"]');
        var eightsecondInput = document.querySelector('input[name="eightsecond"]');
        var eightsummerInput = document.querySelector('input[name="eightsummer"]');
        ...
        sevenfirstInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });

        sevensecondInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });

        sevensummerInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });

        eightfirstInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });

        eightsecondInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });

        eightsummerInput.addEventListener('input', function() {
            validateOptionalYearInput2(this, /^[0-9]{4}-[0-9]{4}$/, 'Invalid Year Format');
        });
        ...
        var subfiveInput = document.querySelector('input[name="subfive"]');
        var subsixInput = document.querySelector('input[name="subsix"]');
        var subsevenInput = document.querySelector('input[name="subseven"]');
        var subeightInput = document.querySelector('input[name="subeight"]');
        ...
        subfiveInput.addEventListener('input', function() {
            if (this.value.trim() === '') {
                clearMessages(this);
            } else {
                validateInputSubjects(this);
        ...
        subsixInput.addEventListener('input', function() {
            if (this.value.trim() === '') {
                clearMessages(this);
            } else {
                validateInputSubjects(this);
        ...
        subsevenInput.addEventListener('input', function() {
            if (this.value.trim() === '') {
                clearMessages(this);
            } else {
                validateInputSubjects(this);
        ...
        subeightInput.addEventListener('input', function() {
            if (this.value.trim() === '') {
                clearMessages(this);
            } else {
                validateInputSubjects(this);
        ...
        function checkAllSubjects() {
            if ((suboneInput.value.trim() === '' || /^[a-zA-Z0-9\- ]+$/.test(suboneInput.value.trim())) ||
                ...
                (subfiveInput.value.trim() === '' || /^[a-zA-Z0-9\- ]+$/.test(subfiveInput.value.trim())) ||
                (subsixInput.value.trim() === '' || /^[a-zA-Z0-9\- ]+$/.test(subsixInput.value.trim())) ||
                (subsevenInput.value.trim() === '' || /^[a-zA-Z0-9\- ]+$/.test(subsevenInput.value.trim())) ||
                (subeightInput.value.trim() === '' || /^[a-zA-Z0-9\- ]+$/.test(subeightInput.value.trim()))) {
        ...
        var unitfiveInput = document.querySelector('select[name="unitfive"]');
        var unitsixInput = document.querySelector('select[name="unitsix"]');
        var unitsevenInput = document.querySelector('select[name="unitseven"]');
        var uniteightInput = document.querySelector('select[name="uniteight"]');
        ...
        unitfiveInput.addEventListener('change', function() {
            if (this.value.trim() === '') {
                clearMessage(this);
            } else {
                validateUnit(this);
        ...
        unitsixInput.addEventListener('change', function() {
            if (this.value.trim() === '') {
                clearMessage(this);
            } else {
                validateUnit(this);
        ...
        unitsevenInput.addEventListener('change', function() {
            if (this.value.trim() === '') {
                clearMessage(this);
            } else {
                validateUnit(this);
        ...
        uniteightInput.addEventListener('change', function() {
            if (this.value.trim() === '') {
                clearMessage(this);
            } else {
                validateUnit(this);
        ...
        function enableDisableNextButton(enabled) {
            document.getElementById('regad_next').disabled = !enabled;
        }
