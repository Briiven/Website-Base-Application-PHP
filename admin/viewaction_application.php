                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="">
                        ...
                        ?>
                                    ...
                                    <h6 class="text-blue h6">FIRST YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                    ...
                                    <h6 class="text-blue h6">SECOND YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Semester</label>
                                    ...
                                    <h6 class="text-blue h6">THIRD YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Semester</label>
                                    ...
                                    <h6 class="text-blue h6">FOURTH YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Semester</label>
                                    ...
                                    <h6 class="text-blue h6">FIFTH YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Semester</label>
                                    ...
                                    <h6 class="text-blue h6">SIXTH YEAR</h6>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Semester</label>
