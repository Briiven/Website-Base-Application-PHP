					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								$sql = "SELECT application.id as lid, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, applicants.program, application.appType, application.appDate, application.RAstatus, application.CRstatus, application.DHstatus, application.CDstatus, application.CRremarkDate 
										FROM application 
										JOIN applicants ON application.appID = applicants.appID 
										WHERE durationID = '$session_duration_id' AND application.CRstatus = $CRstatus";
								...
								?>
									...
									<td><?php echo $row['CRremarkDate']; ?></td>
									<td>
