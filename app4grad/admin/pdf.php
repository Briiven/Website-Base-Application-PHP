...
<?php
// Ensure a valid LID is provided
if (isset($_GET['appid'])) {
    // Retrieve the 'lid' value from the URL parameters
    $appid = $_GET['appid'];

    // Now you can use $appid in your PDF generation code or any other processing
    //echo "The 'appid' value passed from the form is: $appid";
} else {
    // Handle the case where 'appID' is not set in the URL parameters
    // You can either display an error message or redirect the user
    //echo "No 'appid' value was passed in the URL.";
    // You might want to add further logic here, such as redirecting the user
}
...
if (in_array($applicant_program, ['BSIT', 'BSCS'])) {
...
$dompdf->render();
$filename = htmlspecialchars($row['studNum']) . '_' . htmlspecialchars($row['lastName']) . '.pdf';
