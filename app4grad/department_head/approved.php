					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								...
								// Define the status to filter approved applications
								$DHstatus = 1;

								// Build SQL query
								$sql = "SELECT application.id as lid, durationID, applicants.firstName, applicants.lastName, applicants.location, applicants.appID, applicants.program, application.appType, application.appDate, application.RAstatus, application.CRstatus, application.DHstatus, application.CDstatus, application.DHremarkDate
										FROM application 
								...
								?>
									<tr>
										...
										<td><?php echo $row['DHremarkDate']; ?></td>
										<td>
