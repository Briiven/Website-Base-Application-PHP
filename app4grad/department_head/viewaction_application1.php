...
<?php
// code for updating the read notification status
$isRead = 1;
$did = intval($_GET['appid']);
date_default_timezone_set('Asia/Manila');
$RAremarkDate = date('Y-m-d G:i:s', strtotime("now"));
$sql = "UPDATE application SET isRead = :isRead WHERE id = :did";
...
if (isset($_POST['update'])) {
    ...
    $RAremark = $_POST['RAremark'];

    date_default_timezone_set('Asia/Manila');
    $RAremarkDate = date('Y-m-d G:i:s', strtotime("now"));

    if ($RAstatus === '2') {
        $sql = "UPDATE application SET RAstatus = :RAstatus, RAremarkDate = :RAremarkDate, RAremark = :RAremark  WHERE id = :did";

        $query = $dbh->prepare($sql);
        $query->bindParam(':RAstatus', $RAstatus, PDO::PARAM_INT);
        $query->bindParam(':RAremarkDate', $RAremarkDate, PDO::PARAM_STR);
        $query->bindParam(':RAremark', $RAremark, PDO::PARAM_STR);
        $query->bindParam(':did', $did, PDO::PARAM_INT);
        $query->execute();
        echo "<script>
            document.addEventListener('DOMContentLoaded', function () {
                Swal.fire({
                    ...
                    window.location = 'pending1.php';
                });
            });
        </script>";
    } elseif ($RAstatus === '1') {
        $sql = "UPDATE application, applicants SET application.RAstatus = :RAstatus, application.RAremarkDate = :RAremarkDate, application.RAremark = :RAremark WHERE application.appID = applicants.appID AND application.id = :did";
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="pending1.php">Pending Applications</a></li>
											...
											<div class="col-md-12 col-sm-12">
												<div class="form-group">
													...
													<div class="modal-footer justify-content-center">
														<button class="btn btn-success" id="action_take" data-toggle="modal" data-target="#success-modal">Take&nbsp;Action</button>
													</div>
												</div>
											</div>
													...
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content">
															<div class="modal-body text-center font-18">
																...
																<select name="RAstatus" required class="custom-select form-control">
																...
																<div class="form-group">
																	<label></label>
																	<textarea id="textarea1" name="RAremark" class="form-control" placeholder="Description" length="300" maxlength="300"></textarea>
																</div>
															</div>
															<div class="modal-footer justify-content-center">
